...
CREATE TABLE `cliente` (
  ...
  `estado_aprobacion` varchar(20) COLLATE utf8_spanish2_ci NOT NULL DEFAULT 'Pendiente'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_s
...
ALTER TABLE `cliente`
MODIFY `estado_aprobacion` INT NOT NULL DEFAULT 0;
