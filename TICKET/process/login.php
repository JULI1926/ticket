<?php 
    ...
    if($nombre!="" && $clave!="" && $radio!=""){
        if($radio=="admin"){
            ...
            //$sql = Mysql::consulta("SELECT * FROM cliente WHERE nombre_usuario= '$nombre' AND clave='$clave' AND estado_aprobacion = 1");
            ...
            if (mysqli_num_rows($sql) >= 1) {
                ...
                echo '
                    <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                        ...
                        <h4 class="text-center">OCURRIÓ UN ERROR</h4>
                        <p class="text-center">
                            Nombre de usuario o contraseña incorrectos o cuenta no aprobada.
                        </p>
                    </div>
                '; 
            }
            ...
            echo '
                <div class="alert alert-danger alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <h4 class="text-center">OCURRIÓ UN ERROR</h4>
                    <p class="text-center">
                        No has seleccionado un usuario válido.
                    </p>
                </div>
            ';
        }
